...
query = "When is GPT4 released?"
openai.api_key = os.getenv("OPENAI_API_KEY")

# 1. serp request to get a list of relevant articles
def search(query):
...
def summarise(data, query):
    ...
    prompt_template = PromptTemplate(input_variables=["query", "query"], template=template)
